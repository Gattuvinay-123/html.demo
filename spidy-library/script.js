...
//callbackfn: (value: { title: string; isbn: string; pageCount: number; publishedDate: { $date: string; }; thumbnailUrl: string; shortDescription: string; longDescription: string; status: string; authors: string[]; categories: string[]; } | ... 4 more ... | { ...; }, index: number, array: ({ title: string; isbn: string; pageCount: number; publishedDate: { $date: string; }; thumbnailUrl: string; shortDescription: string; longDescription: string; status: string; authors: string[]; categories: string[]; } | ... 4 more ... | { ...; })[]) => void, thisArg?: any): void//
books.forEach(function(book){
    ...
    const pgc=document.createElement("p")
    pgc.textContent="pagecount:"+book.pageCount
		bookdiv.append(image,title,author,isbn,pgc)
